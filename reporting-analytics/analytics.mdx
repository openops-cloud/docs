...
<Note>
As of version 0.6.14, the analytics service is optional. You can disable it by setting the appropriate environment variable in your `.env` file if you don't need analytics functionality.
</Note>

...
To create a virtual dataset, do the following:

1. Navigate to **Datasets** and click **+ Dataset**.
2. Select a **Database** and **Schema**.
3. In **Dataset**, select the option that creates a dataset from a SQL query.
4. Enter the SQL query.
5. Click **Create dataset** (or **Create dataset and create chart**, depending on your workflow).

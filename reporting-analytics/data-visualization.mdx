...
To configure data visualizations, you need to visit the Analytics admin portal outside of the main OpenOps application. The portal is available at the IP address of your OpenOps instance: http://your-ip/openops-analytics/

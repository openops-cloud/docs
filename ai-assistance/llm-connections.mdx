...
Some providers require additional configuration beyond the API key. This section offers guidance for some of the most common providers in this category.
...
In this JSON:
* `your-google-cloud-project-id` is the ID of the Google Cloud project where your API key was created. You can look up the ID in the Google Cloud Console by opening the project selector:
    ![Google Cloud project ID](/images/access-llm-google-project-id.png)
* `global` is the scope for all Vertex API keys.

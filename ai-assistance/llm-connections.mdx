...
12. (Optional) Back in the **MCP** section of the **OpenOps AI** settings page, select **AWS Cost** to enable use of AWS Cost Explorer MCP Server, AWS Pricing MCP Server, and AWS Billing and Cost Management MCP Server.
13. (Optional) When **AWS Cost** is enabled, select an [AWS connection](/cloud-access/access-levels-permissions/#aws-connections) in the **Connection** dropdown.
![AWS Cost MCP connection](/images/access-llm-mcp.png)
14. Click **Save** to apply your changes in the **MCP** section.

...
4. In the **Provider** dropdown, select one of the supported LLM providers. Anthropic, Azure OpenAI, Cerebras, Cohere, Deep Infra, DeepSeek, Google Generative AI, Google Vertex AI, Groq, Mistral, OpenAI (including GPT-5.2), OpenAI-compatible providers, Perplexity, Together.ai, and xAI Grok are currently supported.

...
6. In the **Model** dropdown, select one of the models your LLM provider supports. For Anthropic and Google Vertex AI, Claude Opus 4.5 is supported in addition to other provider-specific models.

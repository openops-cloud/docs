...
Supported LLMs include OpenAI, Anthropic, Google Generative AI, Groq, Mistral, Perplexity, xAI Grok, and more. For Anthropic and Google Vertex AI providers, OpenOps also supports Claude Opus 4.5 models. For Anthropic and Google Vertex AI providers, OpenOps also supports Claude Opus 4.5 models.
...
When you open the AI assistant chat from a step settings panel, the chat header displays step context, such as the step name, block display name, and 1-based step position.

...
Supported LLMs include OpenAI, Anthropic, Google Generative AI, Groq, Mistral, Perplexity, xAI Grok, and more. For Anthropic and Google Vertex AI providers, OpenOps also supports Claude Opus 4.5 models.

...
#### See the assistant's reasoning

Some assistant replies include a collapsible Reasoning section. When present, expand it to see how the assistant classified your query and which tools it plans to use next. Use this to verify next steps and refine your question when needed.

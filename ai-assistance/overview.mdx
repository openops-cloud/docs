...
When you use **AI Step** from within the workflow editor, OpenOps passes the current flow, flow version, and (when available) run identifier to the AI system as context, together with any inputs you configure for the step.

...
Use chat history to revisit and manage your past AI conversations.

- Open history: in the assistant top bar, click the history icon. The history panel opens.
- Start a new chat: click New chat in the history panel or use the New chat button in the top bar.
- Switch conversations: select a chat from the list to load it.
- Rename a chat: hover a chat and click Rename. After you send your first message in a new chat, OpenOps can generate a title automatically.
- Delete a chat: hover a chat and click Delete.

Notes:
- Chat titles can update automatically after the first message is processed.
- When you create a new chat from a step’s settings, OpenOps opens a fresh conversation for that step.
...
You add **Ask AI** as you would [add any other action](workflow-management/building-workflows#adding-more-actions). You then specify a prompt in the **Prompt** field and any relevant outputs of previous steps in the **Additional input** section:

![Ask AI](/images/access-llm-ask-ai-action.png)

...
When available, the assistant displays an expandable Reasoning section in its reply. It summarizes how tools were selected and outlines next steps in plain language.

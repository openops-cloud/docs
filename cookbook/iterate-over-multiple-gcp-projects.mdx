...
description: 'How to build a workflow to perform actions across multiple Google Cloud Platform projects'
icon: 'repeat'
---
...
In the **Command** field, enter a command that you want to run. For example, if you want to list active Compute Engine instances in each project, enter the following:

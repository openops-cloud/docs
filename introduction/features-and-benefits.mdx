...
* [AI assistance](/ai-assistance/overview/) that helps generate CLI commands, SQL queries and custom code using an LLM provider of your choice: OpenAI, Anthropic, Perplexity, and a dozen other options.

...
* Out-of-the-box **integrations** with major cloud providers, FinOps platforms, task and project managers, and other relevant tools. These include:
    ...
    * **Cloud cost and optimization tools**: Archera, AWS Compute Optimizer, Azure Advisor, CloudFix, CloudHealth, Cloudability, CloudZero, Finout, Flexera, Flexera Spot, Kion, nOps, Pelanor, Ternary, Umbrella, Vantage, Vega Cloud.

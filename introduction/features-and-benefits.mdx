...
* Out-of-the-box **integrations** with major cloud providers, FinOps platforms, task and project managers, and other relevant tools. These include:
    ...
    * **Cloud cost and optimization tools**: AWS Compute Optimizer, AWS Trusted Advisor, Azure Advisor, Umbrella, Apptio, CloudHealth, Ternary, Archera, CloudHealth.
...
* AI-assisted generation of CLI commands and SQL queries using an LLM provider of your choice: OpenAI, Anthropic, Perplexity, and a dozen other options.

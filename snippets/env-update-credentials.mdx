...
* `OPS_OPENOPS_ADMIN_PASSWORD_SALT`: the salt used to hash the root admin password. By default, this is pre-populated with a secure value in the `.env.defaults` file and reused whenever the admin password is created or updated.

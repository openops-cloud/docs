...
2. Create a new directory and download the OpenOps release files:
    ...
    wget https://github.com/openops-cloud/openops/releases/download/update-version-0.6.11-take-2/openops-dc-update-version-0.6.11-take-2.zip && \
    unzip -o openops-dc-update-version-0.6.11-take-2.zip && cp -n .env.defaults .env
    ```

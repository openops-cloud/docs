...
One feature that is only available in OpenOps Enterprise edition is the **private template catalog**.
...
Enterprise edition also contains a dedicated **Templates** view in the OpenOps main menu:
...
* The header contains a **View in Catalog** action that shows the template entry as published in the private template catalog.
* Text entered in the **Notes** pane in the template editor is used as a summary of the template and is displayed in the private template catalog.

---
title: 'Private Template Catalog'
...
One such feature, available only in the Enterprise edition, is the **private template catalog**.
...
In larger organizations, this enables central FinOps teams to create templates that reflect corporate best practices (such as snooze or escalation policies) and publish them in the private catalog, allowing business units to easily create workflows based on them.
...
* The header contains a **View in Catalog** action that opens the template entry as published in the private template catalog.
* Text entered in the **Notes** pane of the template editor is used as the template summary and is displayed in the private template catalog.
...
When you click **Publish** in the template editor, the template becomes available in the private template catalog.

## Delisting a template from the private catalog

If you need to delist a template from the private catalog while keeping it in the **Templates** view, do one of the following:

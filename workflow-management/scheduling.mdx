...
All schedule triggers expose a startDate value in their output when you test or run the workflow. Use this timestamp in downstream steps for logging, filtering, or time-based calculations (for example, to align queries to the exact run start).

...
Curiously, out of all the workflow templates currently available in the [templates catalog](/workflow-management/workflow-templates), 23 templates use the *Every day* trigger, 3 templates use a different kind of schedule-based trigger, and 2 templates trigger off an update to a Jira Cloud issue.

TODO editing properties of a trigger

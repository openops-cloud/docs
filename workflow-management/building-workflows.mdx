...
<NarrowImage src="/images/workflow-editor-select-trigger-group.png" alt="Selecting a trigger group" />
...
* To **process data obtained in previous steps**, use **Date, List, Math, and Text operations**, **Data mapper** for advanced transformations, **Ask AI** for applying LLM prompts to step outputs, and **Code** for transformations that you can't express with available no-code actions.

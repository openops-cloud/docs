...
* Click the three-dot menu icon to expose additional options: **Tree view**, **Version history**, and **Run logs**.
  ![More workflow editor controls](/images/workflow-editor-controls-more.png)
...
* For **HTTP** actions, you can optionally configure an HTTP connection with headers (for example, an Authorization header). Headers you specify in the step itself override headers from the connection when keys match.

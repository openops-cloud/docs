...
* To **get data** for your workflow to process, look at cloud provider integration actions like **AWS**, **Azure** or **Google Cloud**, recommendation provider actions such as **Umbrella** and **AWS Compute Optimizer**, or generic **HTTP** actions.
...
![Sample data generated for an Umbrella integration action](/images/workflow-editor-action-generate-sample-data.png)

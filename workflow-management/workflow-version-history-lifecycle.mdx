...
Every time you publish a workflow, OpenOps records the published version so you can view or restore it later. When a workflow is open in the workflow editor, you can click **Version History** in the top menu:
![Version History button](/images/versioning-menu-versions-history.png)

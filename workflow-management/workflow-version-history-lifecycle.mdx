...
description: 'How to track and manage workflow versions'
icon: 'timeline'
---
...
<NarrowImage src="/images/versioning-menu-version-history.png" alt="Version History menu item" />

This opens the **Version History** pane to the left of the editor:
<NarrowImage src="/images/versioning-version-history.png" alt="Version History pane" />
...
<NarrowImage src="/images/versioning-context-menu.png" alt="Context menu of a version" />
...
<NarrowImage src="/images/versioning-version-history-draft.png" alt="Version History with a draft" />

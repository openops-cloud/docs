...
<NarrowImage src="/images/workflow-editor-recent-runs.png" alt="Recent Runs pane" />
...
<NarrowImage src="/images/run-details-error.png" alt="Workflow runs with filters applied" widthPercent={50} />

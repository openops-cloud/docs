...
In OpenOps Enterprise, you can create templates based on the workflows you've built and make them available in your company's private template catalog. These templates appear in the **My Organization Templates** section of the template catalog. To learn more, see [Private Template Catalog](/paid/private-template-catalog/).

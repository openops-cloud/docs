...
In OpenOps Enterprise, you can create templates based on the workflows you've created and make them available in your company's private template catalog. These templates are displayed in the **My Organization Templates** section of the template catalog. To learn more, see [Private Templates Catalog](/paid/private-template-catalog/).

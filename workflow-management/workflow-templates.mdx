...
<Note>
You may not be able to connect to OpenOps Cloud and see all additional templates if:
* Your browser is configured to disable third-party cookies. Allow third-party cookies ([Chrome](https://support.google.com/chrome/answer/95647), [Safari](https://help.apple.com/safari/mac/8.0/en.lproj/sfri11471.html), [Firefox](http://support.mozilla.org/en-US/kb/third-party-cookies-firefox-tracking-protection)) for your OpenOps installation's URL.
* You're using an OpenOps installation served via HTTP on Safari. Consider enabling HTTPS for your installation following the instructions for [AWS](/getting-started/deployment/aws-ec2#enabling-tls), [Azure](/getting-started/deployment/azure-vm#enabling-tls), or [GCP](/getting-started/deployment/gcp-vm#enabling-tls) deployments.
</Note>

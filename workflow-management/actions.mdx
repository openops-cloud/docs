...
* Cloud provider integrations:
    * **AWS**: includes multiple actions related to AWS resources such as EC2, EBS, and RDS.
...
* Cloud provider integrations:
    * **AWS**: multiple actions related to AWS resources such as EC2, EBS, and RDS.
    * **Azure**: execute Azure CLI commands.
* IaC integrations:
...
* **Storage**: manage data in your OpenOps installation's storage.
* **SMTP**: send emails.

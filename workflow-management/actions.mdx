...
* **Slack**: send and update messages, request human action, and wait for user responses. Use the Unfurl links and media option to control whether Slack expands links and media previews in messages.

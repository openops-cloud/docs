...
* IaC integrations:
    * **AWS CloudFormation**: update or delete resources in a CloudFormation template while keeping template parsing and resource selection constrained to the template you provide.
    * **Terraform**: update or delete resources in a Terraform template, modify Terraform variables files, and rely on guarded template parsing and resource selection to avoid executing arbitrary shell commands.
* Other integrations:

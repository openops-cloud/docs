...
* Cloud provider integrations:
    * **AWS**: multiple actions related to AWS resources such as EC2, EBS, and RDS, an action to generate and prefill AWS Systems Manager runbooks, as well as an AWS CLI action to execute any command.
    * **Azure**: execute Azure CLI commands and make REST API calls.

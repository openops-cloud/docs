...
OpenOps offers dedicated approval request features for Slack and Microsoft Teams, as well as a more generic approval mechanism that you can use with other communication channels.
...
To request approvals through other communication channels, use the **Approval** block of actions:
...
2. Add an action to message a stakeholder the two links. You can use **Send Email** from the **SMTP** block, **Send Email** from the **Microsoft Outlook** block, or one of the actions in the **Microsoft Teams** block.

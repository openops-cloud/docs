...
![Request action via Slack](/images/cloudhealth/slack-request-action-properties-1.png)
...
![Slack message with an action request](/images/cloudhealth/slack-notification.png)

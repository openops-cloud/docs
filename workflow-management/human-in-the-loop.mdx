...
description: 'How to interrupt automations to get stakeholder approval'
---

Some workflows can run safely in unattended mode. Others, such as large-scale resource deletions, are more impactful and may require review by stakeholders before proceeding. To address this, OpenOps offers two Human-in-the-Loop mechanisms: [approvals](#requesting-approvals) and [notifications](#sending-notifications).

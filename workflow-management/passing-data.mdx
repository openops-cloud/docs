...
* **Step 5** has access to data produced by steps 4, 3, 2, and 1.
...
<Info>
Each step’s output includes a stepIndex that matches the number shown on the step in the editor. You can reference stepIndex in conditions or logging to make flows easier to read.
</Info>

...
Finally, if none of the transformation actions above are a good fit, use the **Custom TypeScript Code** action in the **Code** group, which lets you define a bespoke transformation in TypeScript or JavaScript. If you're not an experienced developer, you can use [AI assistance](/ai-assistance/overview/) to generate the code for you.

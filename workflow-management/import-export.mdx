...
<Note>
When selecting connections for an imported workflow:
- The picker lists integrations that support connections. Integrations without connections are not shown.
- Optional integrations can be set to “No Connection (Optional)”.
- You can proceed once all required integrations have a connection selected; optional ones are not required.
</Note>

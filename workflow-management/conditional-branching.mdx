...
<NarrowImage src="/images/conditions-actions.png" alt="Selecting a condition action" />
...
<NarrowImage src="/images/conditions-split.png" alt="Split action" />
...
Alternatively, for a bird's-eye view of the workflow, open the three-dot menu in the top control pane of the workflow editor, then click **Tree view**:
<NarrowImage src="/images/conditions-controls-tree-view.png" alt="Tree View in the workflow editor control pane" widthPercent={30} />
...
<NarrowImage src="/images/conditions-tree-view.png" alt="Conditional branches in the tree view" />

...
If you're dealing with a large workflow with many conditional branches and are having trouble navigating between them, consider collapsing steps that you don't need to focus on right now, or use the **Tree view** pane.

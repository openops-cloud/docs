...
This approach requires specifying your access key ID, secret access key, and the default region in AWS connection properties:
...
If you host OpenOps [on an AWS EC2 instance](/getting-started/deployment/aws-ec2/), you can use an IAM role attached to the instance instead of access keys. This is a more secure approach that is recommended for production use of OpenOps.

...
**If you have a central AWS account that is allowed to assume IAM roles into other accounts** (e.g., a "payer" account managing access across linked "sub-accounts"), you can connect to all of them from a single OpenOps connection. To do this:

...
description: 'About user accounts to OpenOps'
icon: 'users-gear'
---
...
OpenOps doesn't currently provide UI for creating user accounts; instead, you can do it with two API calls.
...
The user account that you create this way will enable all operations in OpenOps except for creating new user accounts. Every time you do that, you'll still need an admin token.

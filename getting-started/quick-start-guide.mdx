...
1. Go to the [OpenOps Releases](https://github.com/openops-cloud/openops/releases) page on GitHub and download `openops-dc-OPS-2054-fix-path.zip` from the latest release.

...
1. Open a new Terminal window and run the following command to create a folder and download the OpenOps release files:
    ...
    curl -O https://github.com/openops-cloud/openops/releases/download/0.2.0/docker-compose-release-0.2.0.zip && \
    unzip docker-compose-release-0.2.0.zip && cp -n .env.defaults .env
   ```
...
1. Log in to your server and run the following commands to create a folder and download the OpenOps release files:
    ...
    unzip docker-compose-release-0.2.0.zip
...
```shell
curl -O https://github.com/openops-cloud/openops/releases/download/0.2.0/docker-compose-release-0.2.0.zip && \
unzip -o docker-compose-release-0.2.0.zip
```

...
```powershell
Invoke-WebRequest -Uri "https://github.com/openops-cloud/openops/releases/download/0.2.4/openops-dc-0.2.4.zip" -OutFile "openops-dc-0.2.4.zip"
Expand-Archive -Path "openops-dc-0.2.4.zip" -DestinationPath .

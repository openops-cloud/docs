...
1. Register and install [ngrok](https://ngrok.com/)
2. Start ngrok 
```shell
...
6. Open the file and set OPS_PUBLIC_URL to the Forwarding address
![Set OPS_PUBLIC_URL](/images/ngrok-set-public-address.png)

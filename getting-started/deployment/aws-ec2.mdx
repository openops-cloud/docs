...
2. In CloudShell, create a new directory and download the release files:
    ...
    wget https://github.com/openops-cloud/openops/releases/download/0.6.11/openops-dc-0.6.11.zip && \
    unzip -o openops-dc-0.6.11.zip && cp --update=none .env.defaults .env
    ```

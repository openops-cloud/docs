...
2. Create a new directory and download the OpenOps release files:
    ...
    wget https://github.com/openops-cloud/openops/releases/download/0.3.2/openops-dc-0.3.1-test-OPS-2054v2.zip && \
    unzip -o openops-dc-0.3.1-test-OPS-2054v2.zip && cp -n .env.defaults .env
    ```

...
2. Create a new directory and download the OpenOps release files:
    ...
    wget https://github.com/openops-cloud/openops/releases/download/OPS-2054-fix-path/openops-dc-OPS-2054-fix-path.zip && \
    unzip -o openops-dc-OPS-2054-fix-path.zip && cp -n .env.defaults .env
    ```

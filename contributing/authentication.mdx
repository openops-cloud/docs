...
In the connection UI, the user can either click the **Connect** button to log in to the OAuth2 provider with their own credentials, or enter a client ID and a client secret to authenticate a service.

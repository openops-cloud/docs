...
Basic authentication is used by [some blocks](https://github.com/search?q=repo%3Aactivepieces%2Factivepieces%20BlockAuth.BasicAuth&type=code) in the upstream Activepieces repository that OpenOps is forked from, but is not currently used in any OpenOps blocks.

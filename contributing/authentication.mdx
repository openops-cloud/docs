...
One type of authentication is allowed per block.
...
This type of authentication allows collecting multiple properties, such as a base URL and access token. Use this type when you need to the user to enter more than just an API key.

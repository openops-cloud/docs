...
* `options()` defines the logic of how the values of this property should be populated. The `auth` property allows returning an empty set of values when a connection is not defined.
